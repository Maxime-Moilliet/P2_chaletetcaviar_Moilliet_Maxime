...
if (!function_exists('social_media_expert_enqueue_scripts')) {
	...
	function social_media_expert_enqueue_scripts() {
		...
		wp_add_inline_style( 'social-media-expert-style', $css );
...
function social_media_expert_logo_resizer() {
	...
	';
    wp_add_inline_style( 'social-media-expert-style',$theme_logo_size_css );	
 ...
 */
add_filter('loop_shop_columns', 'social_media_expert_loop_columns', 999);
...
function social_media_expert_remove_sections( $wp_customize ) {
	$wp_customize->remove_control('display_header_text');
	$wp_customize->remove_setting('display_header_text');
	$wp_customize->remove_control('header_textcolor');
	$wp_customize->remove_setting('header_textcolor');	
}
add_action( 'customize_register', 'social_media_expert_remove_sections');

add_action( 'wp_enqueue_scripts', 'social_media_expert_load_dashicons_front_end' );
function social_media_expert_load_dashicons_front_end() {
...
//redirect
Function social_media_expert_notice(){
    global $pagenow;
    if ( is_admin() && ('themes.php' == $pagenow) && isset( $_GET['activated'] ) ) {
   		wp_safe_redirect( admin_url("themes.php?page=social-media-expert-guide-page") );
   	}
}
add_action('after_setup_theme', 'social_media_expert_notice');
