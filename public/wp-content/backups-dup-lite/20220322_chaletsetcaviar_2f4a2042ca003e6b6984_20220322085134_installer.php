...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220322_chaletsetcaviar_2f4a2042ca003e6b6984_20220322085134_archive.zip';
	const ARCHIVE_SIZE		 = '125913119';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '2f4a204-22085134';
    const SECONDARY_PACKAGE_HASH = '6b3ef11-22085134';
	const VERSION			 = '1.4.4';
